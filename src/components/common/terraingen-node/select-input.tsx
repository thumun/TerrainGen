  ...
  return (
    <div className="relative flex items-center py-1 pl-3">
      <Select.Root value={value} onValueChange={(newValue) => onChange(newValue as TValue)}>
        ...
        <Select.Trigger className="flex grow cursor-pointer items-center justify-between rounded-md bg-zinc-600 py-2 pr-2 pl-4 font-medium transition-colors hover:bg-zinc-500/60">
          <Select.Value placeholder="Select..." />
          <Select.Icon className="icon-[tabler--chevron-down]">▾</Select.Icon>
        </Select.Trigger>
        <Select.Portal>
          <Select.Content>
